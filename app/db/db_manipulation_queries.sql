...
SELECT P.player_first_name AS playerName, tbl1.character_name AS characterName, R.race_name AS race, tbl1.background AS background, tbl1.Levels, tbl2.class_name AS primaryClass FROM
